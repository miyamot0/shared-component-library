 ...
 * @returns {JSX.Element}
 */
export default function StandardEntryFieldText({ label, currentValue, type, dispatch, }: StandardFieldEntryProps): JSX.Element {
    return (
        <>
            <label><span data-cy={'entry-field-input-text'}>{label}:</span></label>
            <input
                required
                type="text"
